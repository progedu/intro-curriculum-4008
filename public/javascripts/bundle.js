...
setInterval(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.get('/server-status', {}, function (data) {
    ...
    data.loadavg.forEach(function (value, index, array) {
      ...
      var num = jquery__WEBPACK_IMPORTED_MODULE_0___default()("num-".concat(index)); //対応するdivオブジェクトを取得

      num.text(array[index]); //テキストを書き換え

      var bar = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#bar-".concat(index)); //棒グラフオブジェクトを取得
