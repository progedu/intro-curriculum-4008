...
var loadavg1 = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loadavg1');
var loadavg2 = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loadavg2');
var i = 0;
setInterval(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.get('/server-status', {}, function (data) {
    //toString()がなぜ必要かわかりません。下二つは同じように表示されました。
    loadavg1.text("".concat(data.loadavg.toString(), " ").concat(i, "sec\u7D4C\u904E(\u76EE\u5B89)"));
    loadavg2.text("".concat(data.loadavg, " ").concat(i, "sec\u7D4C\u904E(\u76EE\u5B89)"));
    i++;
  });
}, 1000);
