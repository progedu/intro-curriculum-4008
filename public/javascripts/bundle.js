...
var _ref = [jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loadavg'), jquery__WEBPACK_IMPORTED_MODULE_0___default()('#cpuArch'), jquery__WEBPACK_IMPORTED_MODULE_0___default()('#osPlatform'), jquery__WEBPACK_IMPORTED_MODULE_0___default()('#freeMemory')],
    loadavg = _ref[0],
    cpuArch = _ref[1],
    osPlatform = _ref[2],
    freeMemory = _ref[3]; //jQueryオブジェクトをそれぞれ定数にいれる
